    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: FlatButton(
            ...
            onPressed: () =>
                launch("https://github.com/sadiqabubakar526/The_Holy_Quran_App")),
      ),
    );
  }
}
...
class _ShareAppBtnState extends State<ShareAppBtn> {
  String text = "Download the latest Holy Qur'an App on \n\n"
      "https:// \n\nShare More! It is Sadaqa-tul-Jariah:)";
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: FlatButton(
            ...
            onPressed: () =>
                LaunchReview.launch(androidAppId: "https://sadiqabubakar526.github.com")),
      ),
    );
  }
}
